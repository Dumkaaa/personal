...
?>
   <div class="sect"><div style="height:65px;"></div>
    <div class="sect_img"><img style="float: left;" alt="ror-krovli" height="120" width="120" src="<?=$arResult["PICTURE"]["SRC"];?>"><?=$arResult["DESCRIPTION"];?></div></div>
<?
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
    ...
    <div class="ramka">
        <img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" width="115" height="115" alt="<? echo $strTitle; ?>">
    </div><?
