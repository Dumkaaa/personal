...
$MESS['ALX_TP_MESSAGE_INPUTF'] = "Введите символы,";
$MESS['ALX_TP_MESSAGE_INPUTS'] = " изображённые на картинке:";
$MESS['ALX_TP_MESSAGE_SUBMIT'] = "Отправить";
$MESS['ALX_TP_CORRECT_DATE'] = "Введите корректные данные.";
$MESS['ALX_TP_LOAD_FILE'] = "Загрузить файл";
$MESS['ALX_TP_OVERVIEW'] = "Обзор";
$MESS['ALX_TP_RELOADIMG'] = "обновить изображение";
